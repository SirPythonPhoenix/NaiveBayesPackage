...
setup(
  ...
  url = 'https://github.com/SirPythonPhoenix/NaiveBayesPackage',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/SirPythonPhoenix/NaiveBayesPackage/archive/refs/tags/v_0.2.tar.gz',    # I explain this later on
